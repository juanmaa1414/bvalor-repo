...
<div class="container">
    <h3>Cargar un plan de socio</h3>
    <form method="post" action="grabar_plan">
        ...
        <div class="row">
			...
			<div class="col-lg-3">
                <label for="">Cantidad de nros. para sorteo</label>
                <br>
                <input type="text" name="cantNros" id="" class="form-control" value="1">
            </div>
			<div class="col-lg-3">
                <label for="">Terminación</label>
                <br>
                <input type="text" name="numeroTerminacion" id="" class="form-control" value="" maxlength="1">
            </div>
			<div class="col-lg-3">
